  ...
  return (
    <Layout>
      <div className="mx-auto px-2 sm:px-4 text-center py-10 sm:py-20 justify-around flex flex-wrap hero-img bg-opacity-10">
        <div className="w-full sm:w-1/2">
          <div className="sm:px-4">
            ...
            <p className="text-xl sm:text-2xl text-gray-300">Logic Chain is a creative squad, busy designing and building beautiful products, and experiences on mulitple blockchains. Feel free to use and explore our creations.</p>
            <div>
              <div className="flex py-8 w-full justify-center space-x-6">
                <a
                  href="https://justescrow.io/"
                ...
                <a
                  href="https://opensea.io/collection/monster"
                  className="self-center p-3 border border-gray-800 rounded-xl  bg-black hover:bg-gray-600"
                  target="_blank"
                >
                ...
                <a
                  href="https://twitter.com/0xmonster"
                  className="self-center p-3 border border-gray-800 rounded-xl  bg-black hover:bg-gray-600"
                  target="_blank"
                >
                ...
                <a
                  href="https://discord.gg/dJwEJaQ43d"
                  className="self-center p-3 border border-gray-800 rounded-xl  bg-black hover:bg-gray-600"
                  target="_blank"
                >
      ...
      <div className="flex flex-wrap mx-auto sticky top-0 bg-black w-full justify-center text-sm space-x-6 sm:space-x-10 py-4 z-10 sm:text-2xl font-display">
        <div>
          <a className="hover:text-gray-600" href="#start">0xmonster</a>
        </div>
        <div>
          <a className="hover:text-gray-600" href="#chapter1">Gems Up</a>
        </div>
        <div>
          <a className="hover:text-gray-600" href="#chapter2">Joy City</a>
        </div>
        <div>
          <a className="hover:text-gray-600" href="#chapter3">New Launch</a>
        </div>
      </div>
        ...
        <div className="container mx-auto mt-8">
          <div className="flex justify-around">
            <div className="px-4 sm:px-20 py-8 rounded-2xl text-center md:w-2/3 ">
              <span className="uppercase sm:text-xl tracking-widest text-gray-400">Evoke horrers from the beyond here</span>
              <h1 className="text-center mt-4 capitalize">Start here: Get a Monster</h1>
              <p className="text-xl sm:text-2xl text-gray-400">555 Pixel art Monster, summoned by Adventurers. Every piece of artwork is generated by a Generative Adversarial Model (GAN). You can summon monsters, spawn new twisted combinations, and battle against one another. </p>
            </div>
          </div>
        ...
        <div className="container mx-auto mt-8">
          <div className="flex justify-around">
            <div className="px-4 sm:px-20 py-8 rounded-2xl text-center md:w-2/3">
              ...
              <h1 className="text-center mt-4 capitalize">Gems up</h1>
              <p className="sm:text-2xl text-gray-400">Mint, claim, or earn additional powers</p>
            </div>
          </div>
        ...
        <div className="container mx-auto mt-8">
          <div className="flex justify-around">
            <div className="px-4 sm:px-20 py-8 rounded-2xl text-center md:w-2/3">
              ...
              <h1 className="text-center mt-4">Joy City</h1>
              <p className="sm:text-2xl text-gray-400">What is Joy City Metaverse? Earn for investing in vertual assets on the blochain?</p>
            </div>
          </div>
        ...
        <div className="container mx-auto mt-8">
          <div className="flex justify-around ">
            <div className="px-20 py-8 rounded text-center">
              ...
              <h1 className="text-center mt-4">Wen Next?</h1>
            </div>
          </div>
          <div className="text-center sm:text-2xl my-4 sm:w-2/3 mx-auto px-4 ">
            <p className="my-4">Soon.</p>
            <br />
            <a
              target="_blank"
              href="https://a.quest"
